...
extension SourceError
{
    ...
    static func duplicate(_ source: Source, previousSourceName: String? = nil) -> SourceError { SourceError(code: .duplicate, source: source, previousSourceName: previousSourceName) }
}
